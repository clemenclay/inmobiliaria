<?php namespace App\Http\Controllers;
	...
	class AdminPropiedadesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Tipopropiedad","name"=>"tipopropiedad","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			# OLD END FORM
